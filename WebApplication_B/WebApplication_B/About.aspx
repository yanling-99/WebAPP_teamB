<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="WebApplication_B.About" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <br />
    <%-- 標題 About OTEA+ --%>  
    <div class="jumbotron" style="background-color:#8B7E66">
        <font size="38" face="Arial" color="#FFC125"><b>About OTEA+</b></font><br />
        <br />
        <br /><br />
    ...
    <%-- Overseas Taiwanese Engineer Association --%>
    <h1><b style="color:#8B5A2B">Overseas Taiwanese Engineer Association</b></h1>
    ...
    <div class="tabPage">
        ...
        <div class="row" style="text-align:center">
            <div class="col-md-4">
                ...
                <p style="font-size:20px; font-family:'Times New Roman'; color:#8B5A2B; font-weight:bold">
